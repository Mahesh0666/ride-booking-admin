...
export default function TermsGateScreen({ navigation }: any) {
  const { acceptTerms } = useDriverAuth();
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.subtitle}>
          Before you start earning, please review and agree to the following.
        </Text>
        ...
        <View style={styles.summaryCard}>
          ...
          <Text style={styles.summaryText}>
            • Your location is used only while online — so you receive nearby ride requests and riders can track your arrival.
          </Text>
          <Text style={styles.summaryText}>
            • Verification documents are used solely for rider safety.
          </Text>
          <Text style={styles.summaryText}>
