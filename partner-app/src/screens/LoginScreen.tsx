    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        <View style={styles.brand}>
          ...
          <Text style={styles.title}>Ride-Book Partner</Text>
          <Text style={styles.tagline}>Drive. Earn. Grow with us.</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          {step === 'name' && (
            <>
              <Text style={styles.stepTitle}>Welcome, partner!</Text>
              <Text style={styles.newUserHint}>
                Please enter your name. Next you'll add your vehicle & documents to start earning.
              </Text>
              <View style={styles.form}>
                <TextInput
...
const styles = StyleSheet.create({
  ...
  newUserHint: { fontSize: 13, color: COLORS.gray, marginTop: -10, marginBottom: 14, lineHeight: 19 },
